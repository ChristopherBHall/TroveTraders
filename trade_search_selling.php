...
if(isset($_POST['post'])){
	...
	$page = 'http://www.trovetraders.xyz/trade_search_selling.php?item=' . $_POST['itemNameAutoComplete'];
...
<div class="row">
		...
		<div class="col-lg-10 col-md-10 col-sm-8 col-xs-12" id="tradeoffercommentsbackground">
				<div class="row">
					...
					<br/>
							Sort by: <a href="trade_search_selling.php?sort=price&item=<? echo $_GET['item']; ?>">Price</a> | <a href="trade_search_selling.php?sort=recent&item=<? echo $_GET['item']; ?>">Most Recently Bumped</a>
					</div>
				</div>
		</div>
		<div class="col-lg-1 col-md-1 col-sm-4 col-xs-0"></div>
...
<br/>
    ...
    <?php 
	  ...
	  } else { echo '<div id="tradeoffercommentsbackground"> Noone is selling this item currently! </div>'; break; }
				}
			}
			else { echo '<div id="tradeoffercommentsbackground"> Noone is selling this item currently! </div>'; }
		}
